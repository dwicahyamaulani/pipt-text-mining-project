...
CATEGORIES = [
    ...
    "https://www.cnnindonesia.com/internasional/asean",
    "https://www.cnnindonesia.com/internasional/asia-pasifik",
    "https://www.cnnindonesia.com/internasional/timur-tengah",
    "https://www.cnnindonesia.com/internasional/eropa-amerika",
]
NIM = "235150207111041"
INISIAL = "AND"

output_file = "data/3_CRAWL_AfifahNabilaDevi_3.txt"
...
def get_article_links():
    ...
    for url in CATEGORIES:
        ...
        for a in soup.find_all("a", href=True):
            ...
            if link.startswith("https://www.cnnindonesia.com/internasional"):
